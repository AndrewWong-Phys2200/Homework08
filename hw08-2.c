 ...
 *   y' = v sin(theta)
 *
 * and determine the flight distance versus initial angle.
 *
...
int main (void) 
{
  ...
  int i, np = 50;
  double theta1 = -M_PI/3., theta2 = M_PI/3., theta;
  double step;
  
  step = (theta2 - theta1)/(np - 1);
  ...
  for (i = 0; i < np; i++)
  {
     ...
     * Initial conditions 
     */
    double y[4] = { 2., theta, 0., 2. };   /* for res2 */
